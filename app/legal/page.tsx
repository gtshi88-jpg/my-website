...
export default function LegalPage() {
  const rows: { label: string; value: React.ReactNode }[] = [
    ...
    { label: 'メールアドレス', value: <a href={`mailto:${COMPANY.email}`} className="border-b border-black/20 hover:border-black transition-colors">{COMPANY.email}</a> },
  ...
  return (
    <LegalLayout title="Legal Notice" titleJa="特定商取引法に基づく表記" updated={LEGAL_UPDATED}>
      <p className="text-base md:text-lg font-light leading-relaxed text-text-sub mb-10">
